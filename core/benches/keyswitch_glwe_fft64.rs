...
use core::{FourierGLWESecret, GGLWEAutomorphismKey, GLWECiphertext, GLWESecret, GLWESwitchingKey, Infos};
...
fn bench_keyswitch_glwe_fft64(c: &mut Criterion) {
    ...
    fn runner(p: Params) -> impl FnMut() {
        ...
        let mut ksk: GGLWEAutomorphismKey<Vec<u8>, FFT64> =
            GGLWEAutomorphismKey::alloc(&module, basek, k_grlwe, rows, digits, rank_out);
