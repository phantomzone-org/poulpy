...
impl StreamPacker {
    ...
    pub fn scratch_space(module: &Module<FFT64>, basek: usize, ct_k: usize, ksk_k: usize, digits: usize, rank: usize) -> usize {
        pack_core_scratch_space(module, basek, ct_k, ksk_k, digits, rank)
    }
...
fn pack_core_scratch_space(module: &Module<FFT64>, basek: usize, ct_k: usize, ksk_k: usize, digits: usize, rank: usize) -> usize {
    combine_scratch_space(module, basek, ct_k, ksk_k, digits, rank)
}
...
fn combine_scratch_space(module: &Module<FFT64>, basek: usize, ct_k: usize, ksk_k: usize, digits: usize, rank: usize) -> usize {
    GLWECiphertext::bytes_of(module, basek, ct_k, rank)
        + (GLWECiphertext::rsh_scratch_space(module)
            | GLWECiphertext::automorphism_scratch_space(module, basek, ct_k, ct_k, ksk_k, digits, rank))
}
