use poulpy_hal::{
    ...
    reference::{
        zn::{zn_add_normal, zn_fill_normal, zn_fill_uniform, zn_normalize_inplace, zn_normalize_tmp_bytes},
        znx::ZnxNormalizeRef,
    },
    source::Source,
};
...
unsafe impl ZnNormalizeTmpBytesImpl<Self> for FFT64 {
    ...
    Self: TakeSliceImpl<Self>,
{
        ...
        R: ZnToMut,
    {
        ...
        zn_normalize_inplace::<R, ZnxNormalizeRef>(n, basek, res, res_col, carry);
    }
}
