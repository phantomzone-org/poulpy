use poulpy_hal::{
    ...
    reference::{
        vec_znx::{
            ...
            vec_znx_fill_normal_ref, vec_znx_fill_uniform_ref, vec_znx_lsh, vec_znx_lsh_inplace, vec_znx_merge_rings,
            ...
            vec_znx_rotate_inplace_tmp_bytes, vec_znx_rsh, vec_znx_rsh_inplace, vec_znx_split_ring, vec_znx_split_ring_tmp_bytes,
            vec_znx_sub, vec_znx_sub_ab_inplace, vec_znx_sub_ba_inplace, vec_znx_sub_scalar, vec_znx_sub_scalar_inplace,
            vec_znx_switch_ring,
        },
    ...
    Self: TakeSliceImpl<Self> + VecZnxNormalizeTmpBytesImpl<Self>,
{
    fn vec_znx_normalize_impl<R, A>(
        ...
        A: VecZnxToRef,
    {
        let (carry, _) = scratch.take_slice(module.vec_znx_normalize_tmp_bytes());
        vec_znx_normalize::<R, A, ZnxArithmeticRef, ZnxNormalizeRef>(basek, res, res_col, a, a_col, carry);
    }
}
    ...
    Self: TakeSliceImpl<Self> + VecZnxNormalizeTmpBytesImpl<Self>,
{
    ...
    {
        let (carry, _) = scratch.take_slice(module.vec_znx_normalize_tmp_bytes());
        vec_znx_normalize_inplace::<R, ZnxNormalizeRef>(basek, res, res_col, carry);
    }
}
...
unsafe impl VecZnxAddImpl<Self> for FFT64 {
    ...
    where
        ...
        B: VecZnxToRef,
    {
        vec_znx_add::<R, A, B, ZnxArithmeticRef>(res, res_col, a, a_col, b, b_col);
    }
}
...
unsafe impl VecZnxAddInplaceImpl<Self> for FFT64 {
    ...
    where
        ...
        A: VecZnxToRef,
    {
        vec_znx_add_inplace::<R, A, ZnxArithmeticRef>(res, res_col, a, a_col);
    }
}
...
unsafe impl VecZnxAddScalarInplaceImpl<Self> for FFT64 {
    fn vec_znx_add_scalar_inplace_impl<R, A>(
        ...
        A: ScalarZnxToRef,
    {
        vec_znx_add_scalar_inplace::<R, A, ZnxArithmeticRef>(res, res_col, res_limb, a, a_col);
    }
}
...
unsafe impl VecZnxAddScalarImpl<Self> for FFT64 {
    fn vec_znx_add_scalar_impl<R, A, B>(
        ...
        B: VecZnxToRef,
    {
        vec_znx_add_scalar::<R, A, B, ZnxArithmeticRef>(res, res_col, a, a_col, b, b_col, b_limb);
    }
}
...
unsafe impl VecZnxSubImpl<Self> for FFT64 {
    ...
    where
        ...
        B: VecZnxToRef,
    {
        vec_znx_sub::<R, A, B, ZnxArithmeticRef>(res, res_col, a, a_col, b, b_col);
    }
}
...
unsafe impl VecZnxSubABInplaceImpl<Self> for FFT64 {
    ...
    where
        ...
        A: VecZnxToRef,
    {
        vec_znx_sub_ab_inplace::<R, A, ZnxArithmeticRef>(res, res_col, a, a_col);
    }
}
...
unsafe impl VecZnxSubBAInplaceImpl<Self> for FFT64 {
    ...
    where
        ...
        A: VecZnxToRef,
    {
        vec_znx_sub_ba_inplace::<R, A, ZnxArithmeticRef>(res, res_col, a, a_col);
    }
}
...
unsafe impl VecZnxSubScalarImpl<Self> for FFT64 {
    fn vec_znx_sub_scalar_impl<R, A, B>(
        ...
        B: VecZnxToRef,
    {
        vec_znx_sub_scalar::<R, A, B, ZnxArithmeticRef>(res, res_col, a, a_col, b, b_col, b_limb);
    }
}
...
unsafe impl VecZnxSubScalarInplaceImpl<Self> for FFT64 {
    fn vec_znx_sub_scalar_inplace_impl<R, A>(
        ...
        A: ScalarZnxToRef,
    {
        vec_znx_sub_scalar_inplace::<R, A, ZnxArithmeticRef>(res, res_col, res_limb, a, a_col);
    }
}
...
unsafe impl VecZnxNegateImpl<Self> for FFT64 {
    ...
    where
        ...
        A: VecZnxToRef,
    {
        vec_znx_negate::<R, A, ZnxArithmeticRef>(res, res_col, a, a_col);
    }
}
...
unsafe impl VecZnxNegateInplaceImpl<Self> for FFT64 {
    ...
    where
        R: VecZnxToMut,
    {
        vec_znx_negate_inplace::<R, ZnxArithmeticRef>(res, res_col);
    }
}
...
unsafe impl VecZnxRotateImpl<Self> for FFT64 {
    ...
    where
        ...
        A: VecZnxToRef,
    {
        vec_znx_rotate::<R, A, ZnxArithmeticRef>(p, res, res_col, a, a_col);
    }
}
    ...
    Self: VecZnxRotateInplaceTmpBytesImpl<Self>,
{
        ...
        R: VecZnxToMut,
    {
        ...
        vec_znx_rotate_inplace::<R, ZnxArithmeticRef>(p, res, res_col, tmp);
    }
}
...
unsafe impl VecZnxAutomorphismImpl<Self> for FFT64 {
    ...
    where
        ...
        A: VecZnxToRef,
    {
        vec_znx_automorphism::<R, A, ZnxArithmeticRef>(p, res, res_col, a, a_col);
    }
}
    ...
    Self: VecZnxAutomorphismInplaceTmpBytesImpl<Self>,
{
        ...
        R: VecZnxToMut,
    {
        ...
        vec_znx_automorphism_inplace::<R, ZnxArithmeticRef>(p, res, res_col, tmp);
    }
}
...
unsafe impl VecZnxMulXpMinusOneImpl<Self> for FFT64 {
    ...
    where
        ...
        A: VecZnxToRef,
    {
        vec_znx_mul_xp_minus_one::<R, A, ZnxArithmeticRef>(p, res, res_col, a, a_col);
    }
}
...
unsafe impl VecZnxMulXpMinusOneInplaceImpl<Self> for FFT64 {
        ...
        R: VecZnxToMut,
    {
        ...
        vec_znx_mul_xp_minus_one_inplace::<R, ZnxArithmeticRef>(p, res, res_col, tmp);
    }
}
    ...
    Scratch<Self>: TakeSlice,
{
        ...
        A: VecZnxToRef,
    {
        ...
        vec_znx_split_ring::<R, A, ZnxArithmeticRef>(res, res_col, a, a_col, tmp);
    }
}
    ...
    Module<Self>: VecZnxMergeRingsTmpBytes,
{
        ...
        A: VecZnxToRef,
    {
        ...
        vec_znx_merge_rings::<R, A, ZnxArithmeticRef>(res, res_col, a, a_col, tmp);
    }
}
    ...
    Self: VecZnxCopyImpl<Self>,
{
    ...
    where
        ...
        A: VecZnxToRef,
    {
        vec_znx_switch_ring::<R, A, ZnxArithmeticRef>(res, res_col, a, a_col);
    }
}
...
unsafe impl VecZnxCopyImpl<Self> for FFT64 {
    ...
    where
        ...
        A: VecZnxToRef,
    {
        vec_znx_copy::<R, A, ZnxArithmeticRef>(res, res_col, a, a_col)
    }
}
