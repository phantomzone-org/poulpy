use poulpy_hal::reference::vmp::fft64::{test_vmp_apply_dft_to_dft, test_vmp_apply_dft_to_dft_add, test_vmp_prepare};
...
fn vmp_apply_dft_to_dft_add_fft64() {
    test_vmp_apply_dft_to_dft_add::<cpu_spqlios::FFT64>();
}
