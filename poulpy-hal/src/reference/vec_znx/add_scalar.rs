    ...
    Module<B>: VecZnxAddScalar,
{
    ...
    for a_size in [1, 2, 6, 11] {
        ...
        for res_size in [1, 2, 6, 11] {
            ...
            // Reference
            for i in 0..cols {
                vec_znx_add_scalar::<_, _, _, ZnxArithmeticRef>(&mut res_0, i, &a, i, &b, i, (res_size.min(a_size)) - 1);
    ...
    Module<B>: VecZnxAddScalarInplace,
{
    ...
    for res_size in [1, 2, 6, 11] {
        ...
        for i in 0..cols {
            vec_znx_add_scalar_inplace::<_, _, ZnxArithmeticRef>(&mut res_0, i, res_size - 1, &b, i);
