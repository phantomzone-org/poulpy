...
impl<D: DataMut> VecZnx<D> {
    pub fn encode_vec_i64(&mut self, base2k: usize, col: usize, k: usize, data: &[i64], log_max: usize) {
        ...
        let k_rem: usize = base2k - (k % base2k);
    ...
    pub fn encode_coeff_i64(&mut self, base2k: usize, col: usize, k: usize, idx: usize, data: i64, log_max: usize) {
        ...
        if log_max + k_rem < 63 || k_rem == base2k {
            ...
            (size - steps..size)
                ...
                .enumerate()
                .for_each(|(j, j_rev)| {
                    a.at_mut(col, j_rev)[idx] = (data >> (j * base2k)) & mask;
                })
        }
...
impl<D: DataRef> VecZnx<D> {
    ...
    pub fn decode_vec_float(&self, base2k: usize, col: usize, data: &mut [Float]) {
        ...
        // 2^{base2k}
        let base = Float::with_val(prec, (1u64 << base2k) as f64);
...
impl<D: DataMut> Zn<D> {
    pub fn encode_i64(&mut self, base2k: usize, k: usize, data: i64, log_max: usize) {
        let size: usize = k.div_ceil(base2k);
        ...
        if log_max + k_rem < 63 || k_rem == base2k {
            ...
            (size - steps..size)
                ...
                .enumerate()
                .for_each(|(j, j_rev)| {
                    a.at_mut(0, j_rev)[0] = (data >> (j * base2k)) & mask;
                })
        }
