use poulpy_hal::{
    api::{
        ModuleN, ScratchArenaTakeBasic, ScratchAvailable, ScratchFromBytes, ScratchTakeBasic, SvpPPolBytesOf, VecZnxDftBytesOf,
        VmpPMatBytesOf,
    },
    layouts::{Backend, Scratch, ScratchArena},
};
...
///
/// This mirrors [`ScratchTakeCore`] but returns backend-native borrows
/// (`B::BufMut<'a>`) carved from a [`ScratchArena`].
