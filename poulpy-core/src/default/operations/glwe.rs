use poulpy_hal::{
    ...
    layouts::{
        Backend, CnvPVecLReborrowBackendRef, CnvPVecRReborrowBackendRef, Module, ScratchArena, VecZnx,
...
pub use crate::api::{GLWEAdd, GLWEMulConst, GLWEMulPlain, GLWENormalize, GLWERotate, GLWEShift, GLWESub, GLWETensoring};
use crate::{
