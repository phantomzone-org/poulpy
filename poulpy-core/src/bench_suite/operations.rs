...
pub fn bench_glwe_add<BE: Backend, A>(infos: &A, c: &mut Criterion, label: &str)
where
    A: GLWEInfos,
...
pub fn bench_glwe_add_inplace<BE: Backend, A>(infos: &A, c: &mut Criterion, label: &str)
where
    A: GLWEInfos,
    Module<BE>: ModuleNew<BE> + GLWEAdd,
{
...
pub fn bench_glwe_sub<BE: Backend, A>(infos: &A, c: &mut Criterion, label: &str)
where
    A: GLWEInfos,
...
pub fn bench_glwe_sub_inplace<BE: Backend, A>(infos: &A, c: &mut Criterion, label: &str)
where
    A: GLWEInfos,
    Module<BE>: ModuleNew<BE> + GLWESub,
{
...
pub fn bench_glwe_normalize<BE: Backend, A>(infos: &A, c: &mut Criterion, label: &str)
where
    A: GLWEInfos,
...
pub fn bench_glwe_normalize_inplace<BE: Backend, A>(infos: &A, c: &mut Criterion, label: &str)
where
    A: GLWEInfos,
    Module<BE>: ModuleNew<BE> + GLWENormalize<BE>,
    ScratchOwned<BE>: ScratchOwnedAlloc<BE> + ScratchOwnedBorrow<BE>,
...
pub fn bench_glwe_mul_plain<BE: Backend, A>(infos: &A, c: &mut Criterion, label: &str)
where
    A: GLWEInfos,
...
pub fn bench_glwe_mul_plain_inplace<BE: Backend, A>(infos: &A, c: &mut Criterion, label: &str)
where
    A: GLWEInfos,
    Module<BE>: ModuleNew<BE> + GLWEMulPlain<BE>,
    ScratchOwned<BE>: ScratchOwnedAlloc<BE> + ScratchOwnedBorrow<BE>,
