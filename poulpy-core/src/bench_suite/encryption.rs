use crate::{
    ...
    layouts::{
        GGSW, GGSWInfos, GGLWEInfos, GLWEAutomorphismKey, GLWEInfos, GLWESecret,
        GLWESecretPreparedFactory, prepared::GLWESecretPrepared,
    },
};
use poulpy_hal::{
    ...
    Scratch<BE>: ScratchTakeCore<BE>,
{
    ...
    let mut scratch: ScratchOwned<BE> =
        ScratchOwned::alloc(crate::layouts::GLWE::encrypt_sk_tmp_bytes(&module, infos));
    ...
    Scratch<BE>: ScratchTakeCore<BE>,
{
    ...
    let mut scratch: ScratchOwned<BE> =
        ScratchOwned::alloc(GGSW::encrypt_sk_tmp_bytes(&module, infos));
...
pub fn bench_glwe_automorphism_key_encrypt_sk<BE: Backend, A>(
    atk_infos: &A,
    p: i64,
    c: &mut Criterion,
    label: &str,
