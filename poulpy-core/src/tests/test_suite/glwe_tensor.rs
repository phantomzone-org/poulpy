use poulpy_hal::{
    ...
    layouts::{Backend, FillUniform, Module, Scratch, ScratchOwned, VecZnx, ZnxView, ZnxViewMut},
    source::Source,
...
pub fn test_glwe_tensor_square<BE: Backend>(params: &TestParams, module: &Module<BE>)
where
    Module<BE>: GLWETensoring<BE>
        + GLWEEncryptSk<BE>
        + GLWEDecrypt<BE>
