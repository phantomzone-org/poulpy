macro_rules! hal_impl_vec_znx_big_ntt120 {
    () => {
        ...
        where
            ...
            A: VecZnxBigToRef<Self>,
        {
            <Self as NTT120VecZnxBigDefaults<Self>>::vec_znx_big_sub_inplace_default(module, res, res_col, a, a_col)
        }
        ...
        where
            ...
            A: VecZnxBigToRef<Self>,
        {
            <Self as NTT120VecZnxBigDefaults<Self>>::vec_znx_big_sub_negate_inplace_default(module, res, res_col, a, a_col)
        }
        ...
        where
            ...
            A: VecZnxToRef,
        {
            <Self as NTT120VecZnxBigDefaults<Self>>::vec_znx_big_sub_small_inplace_default(module, res, res_col, a, a_col)
        }
        ...
        where
            ...
            A: VecZnxToRef,
        {
            <Self as NTT120VecZnxBigDefaults<Self>>::vec_znx_big_sub_small_negate_inplace_default(module, res, res_col, a, a_col)
        }
        ...
        {
            <Self as NTT120VecZnxBigDefaults<Self>>::vec_znx_big_negate_inplace_default(module, a, a_col)
        }
        ...
        fn vec_znx_big_automorphism_inplace_tmp_bytes(module: &Module<Self>) -> usize {
            <Self as NTT120VecZnxBigDefaults<Self>>::vec_znx_big_automorphism_inplace_tmp_bytes_default(module)
        }
        ...
        fn vec_znx_big_automorphism_inplace<A>(
            ...
            A: VecZnxBigToMut<Self>,
        {
            <Self as NTT120VecZnxBigDefaults<Self>>::vec_znx_big_automorphism_inplace_default(module, k, a, a_col, scratch)
        }
    };
}
