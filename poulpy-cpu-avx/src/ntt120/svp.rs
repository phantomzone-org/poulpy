//! Scalar-vector product (SVP) operations for [`NTT120Avx`](super::NTT120Avx).
//!
...
unsafe impl SvpPrepareImpl<Self> for NTT120Avx {
...
unsafe impl SvpApplyDftToDftImpl<Self> for NTT120Avx {
...
unsafe impl SvpApplyDftToDftAddImpl<Self> for NTT120Avx {
...
unsafe impl SvpApplyDftToDftInplaceImpl for NTT120Avx {
