//! Scratch (temporary) memory management for [`NTT120Avx`](super::NTT120Avx).
//!
...
//! available-space queries. Identical to the `NTT120Ref` implementation — all impls
//! are fully generic over `B: Backend`.
...
unsafe impl<B: Backend> ScratchOwnedAllocImpl<B> for NTT120Avx {
...
unsafe impl<B: Backend> ScratchOwnedBorrowImpl<B> for NTT120Avx
where
...
unsafe impl<B: Backend> ScratchFromBytesImpl<B> for NTT120Avx {
...
unsafe impl<B: Backend> ScratchAvailableImpl<B> for NTT120Avx {
...
unsafe impl<B: Backend> TakeSliceImpl<B> for NTT120Avx
where
    B: ScratchFromBytesImpl<B>,
{
