//! Vector-of-ring-elements operations for [`NTT120Avx`](super::NTT120Avx).
//!
...
unsafe impl VecZnxZeroImpl<Self> for NTT120Avx {
    fn vec_znx_zero_impl<R>(_module: &Module<Self>, res: &mut R, res_col: usize)
    where
        R: VecZnxToMut,
    {
        vec_znx_zero::<_, NTT120Avx>(res, res_col);
    }
}

unsafe impl VecZnxNormalizeTmpBytesImpl<Self> for NTT120Avx {
    fn vec_znx_normalize_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_normalize_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxNormalizeImpl<Self> for NTT120Avx
where
...
unsafe impl VecZnxNormalizeInplaceImpl<Self> for NTT120Avx
where
    Self: TakeSliceImpl<Self> + VecZnxNormalizeTmpBytesImpl<Self>,
{
...
unsafe impl VecZnxAddImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxAddInplaceImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxAddScalarInplaceImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxAddScalarImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxSubImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxSubInplaceImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxSubNegateInplaceImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxSubScalarImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxSubScalarInplaceImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxNegateImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxNegateInplaceImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxLshInplaceImpl<Self> for NTT120Avx
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshImpl<Self> for NTT120Avx
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshInplaceImpl<Self> for NTT120Avx
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRotateImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxRotateInplaceTmpBytesImpl<Self> for NTT120Avx
where
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRotateInplaceImpl<Self> for NTT120Avx
where
    Scratch<Self>: TakeSlice,
...
unsafe impl VecZnxAutomorphismImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxAutomorphismInplaceTmpBytesImpl<Self> for NTT120Avx {
    fn vec_znx_automorphism_inplace_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_automorphism_inplace_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxAutomorphismInplaceImpl<Self> for NTT120Avx
where
    Scratch<Self>: TakeSlice,
...
unsafe impl VecZnxMulXpMinusOneImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxMulXpMinusOneInplaceTmpBytesImpl<Self> for NTT120Avx
where
    Scratch<Self>: TakeSlice,
...
unsafe impl VecZnxMulXpMinusOneInplaceImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxSplitRingTmpBytesImpl<Self> for NTT120Avx {
    fn vec_znx_split_ring_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_split_ring_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxSplitRingImpl<Self> for NTT120Avx
where
...
unsafe impl VecZnxMergeRingsTmpBytesImpl<Self> for NTT120Avx {
    fn vec_znx_merge_rings_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_merge_rings_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxMergeRingsImpl<Self> for NTT120Avx
where
...
unsafe impl VecZnxSwitchRingImpl<Self> for NTT120Avx
where
...
unsafe impl VecZnxCopyImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxFillUniformImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxFillNormalImpl<Self> for NTT120Avx {
...
unsafe impl VecZnxAddNormalImpl<Self> for NTT120Avx {
