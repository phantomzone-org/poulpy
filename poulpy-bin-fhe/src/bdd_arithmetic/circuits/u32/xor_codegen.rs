use crate::bdd_arithmetic::{BitCircuit, BitCircuitFamily, BitCircuitInfo, Circuit, Node};
...
pub(crate) static OUTPUT_CIRCUITS: Circuit<AnyBitCircuit, 32usize> = Circuit([
    AnyBitCircuit::B0(BitCircuit::new(
        [Node::Cmux(32, 0, 1), Node::Cmux(32, 1, 0), Node::Cmux(0, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B1(BitCircuit::new(
        [Node::Cmux(33, 0, 1), Node::Cmux(33, 1, 0), Node::Cmux(1, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B2(BitCircuit::new(
        [Node::Cmux(34, 1, 0), Node::Cmux(34, 0, 1), Node::Cmux(2, 1, 0), Node::None],
        2,
    )),
    AnyBitCircuit::B3(BitCircuit::new(
        [Node::Cmux(35, 0, 1), Node::Cmux(35, 1, 0), Node::Cmux(3, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B4(BitCircuit::new(
        [Node::Cmux(36, 0, 1), Node::Cmux(36, 1, 0), Node::Cmux(4, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B5(BitCircuit::new(
        [Node::Cmux(37, 0, 1), Node::Cmux(37, 1, 0), Node::Cmux(5, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B6(BitCircuit::new(
        [Node::Cmux(38, 1, 0), Node::Cmux(38, 0, 1), Node::Cmux(6, 1, 0), Node::None],
        2,
    )),
    AnyBitCircuit::B7(BitCircuit::new(
        [Node::Cmux(39, 1, 0), Node::Cmux(39, 0, 1), Node::Cmux(7, 1, 0), Node::None],
        2,
    )),
    AnyBitCircuit::B8(BitCircuit::new(
        [Node::Cmux(40, 0, 1), Node::Cmux(40, 1, 0), Node::Cmux(8, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B9(BitCircuit::new(
        [Node::Cmux(41, 1, 0), Node::Cmux(41, 0, 1), Node::Cmux(9, 1, 0), Node::None],
        2,
    )),
    AnyBitCircuit::B10(BitCircuit::new(
        [Node::Cmux(42, 0, 1), Node::Cmux(42, 1, 0), Node::Cmux(10, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B11(BitCircuit::new(
        [Node::Cmux(43, 0, 1), Node::Cmux(43, 1, 0), Node::Cmux(11, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B12(BitCircuit::new(
        [Node::Cmux(44, 0, 1), Node::Cmux(44, 1, 0), Node::Cmux(12, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B13(BitCircuit::new(
        [Node::Cmux(45, 1, 0), Node::Cmux(45, 0, 1), Node::Cmux(13, 1, 0), Node::None],
        2,
    )),
    AnyBitCircuit::B14(BitCircuit::new(
        [Node::Cmux(46, 1, 0), Node::Cmux(46, 0, 1), Node::Cmux(14, 1, 0), Node::None],
        2,
    )),
    AnyBitCircuit::B15(BitCircuit::new(
        [Node::Cmux(47, 1, 0), Node::Cmux(47, 0, 1), Node::Cmux(15, 1, 0), Node::None],
        2,
    )),
    AnyBitCircuit::B16(BitCircuit::new(
        [Node::Cmux(48, 0, 1), Node::Cmux(48, 1, 0), Node::Cmux(16, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B17(BitCircuit::new(
        [Node::Cmux(49, 0, 1), Node::Cmux(49, 1, 0), Node::Cmux(17, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B18(BitCircuit::new(
        [Node::Cmux(50, 0, 1), Node::Cmux(50, 1, 0), Node::Cmux(18, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B19(BitCircuit::new(
        [Node::Cmux(51, 1, 0), Node::Cmux(51, 0, 1), Node::Cmux(19, 1, 0), Node::None],
        2,
    )),
    AnyBitCircuit::B20(BitCircuit::new(
        [Node::Cmux(52, 1, 0), Node::Cmux(52, 0, 1), Node::Cmux(20, 1, 0), Node::None],
        2,
    )),
    AnyBitCircuit::B21(BitCircuit::new(
        [Node::Cmux(53, 0, 1), Node::Cmux(53, 1, 0), Node::Cmux(21, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B22(BitCircuit::new(
        [Node::Cmux(54, 1, 0), Node::Cmux(54, 0, 1), Node::Cmux(22, 1, 0), Node::None],
        2,
    )),
    AnyBitCircuit::B23(BitCircuit::new(
        [Node::Cmux(55, 1, 0), Node::Cmux(55, 0, 1), Node::Cmux(23, 1, 0), Node::None],
        2,
    )),
    AnyBitCircuit::B24(BitCircuit::new(
        [Node::Cmux(56, 0, 1), Node::Cmux(56, 1, 0), Node::Cmux(24, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B25(BitCircuit::new(
        [Node::Cmux(57, 0, 1), Node::Cmux(57, 1, 0), Node::Cmux(25, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B26(BitCircuit::new(
        [Node::Cmux(58, 1, 0), Node::Cmux(58, 0, 1), Node::Cmux(26, 1, 0), Node::None],
        2,
    )),
    AnyBitCircuit::B27(BitCircuit::new(
        [Node::Cmux(59, 0, 1), Node::Cmux(59, 1, 0), Node::Cmux(27, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B28(BitCircuit::new(
        [Node::Cmux(60, 0, 1), Node::Cmux(60, 1, 0), Node::Cmux(28, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B29(BitCircuit::new(
        [Node::Cmux(61, 0, 1), Node::Cmux(61, 1, 0), Node::Cmux(29, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B30(BitCircuit::new(
        [Node::Cmux(62, 0, 1), Node::Cmux(62, 1, 0), Node::Cmux(30, 0, 1), Node::None],
        2,
    )),
    AnyBitCircuit::B31(BitCircuit::new(
        [Node::Cmux(63, 1, 0), Node::Cmux(63, 0, 1), Node::Cmux(31, 1, 0), Node::None],
        2,
    )),
]);
