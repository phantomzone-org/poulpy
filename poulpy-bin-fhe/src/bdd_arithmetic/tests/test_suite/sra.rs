...
pub fn test_bdd_sra<BRA: BlindRotationAlgo, BE: Backend<OwnedBuf = Vec<u8>> + HostBackend>(test_context: &TestContext<BRA, BE>)
where
    ...
    for<'a> BE::BufMut<'a>: HostDataMut,
{
    ...
    res.sra(module, &a_enc_prep, &b_enc_prep, bdd_key_prepared, &mut scratch.borrow());
