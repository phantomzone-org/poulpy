...
#[test]
fn test_convolution_by_const_fft64_avx512() {
    let module: Module<FFT64Avx512> = Module::<FFT64Avx512>::new(8);
    test_convolution_by_const(&module, 17);
}

#[test]
fn test_convolution_fft64_avx512() {
    let module: Module<FFT64Avx512> = Module::<FFT64Avx512>::new(8);
    test_convolution(&module, 17);
}

#[test]
fn test_convolution_pairwise_fft64_avx512() {
    let module: Module<FFT64Avx512> = Module::<FFT64Avx512>::new(8);
