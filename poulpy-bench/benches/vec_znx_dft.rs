...
fn bench_vec_znx_dft_add(c: &mut Criterion) {
    poulpy_bench::for_each_fft_backend!(poulpy_bench::bench_suite::hal::vec_znx_dft::bench_vec_znx_dft_add, &poulpy_bench::params::BenchParams::get().hal; c);
}
fn bench_vec_znx_dft_add_inplace(c: &mut Criterion) {
    poulpy_bench::for_each_fft_backend!(poulpy_bench::bench_suite::hal::vec_znx_dft::bench_vec_znx_dft_add_inplace, &poulpy_bench::params::BenchParams::get().hal; c);
}
