...
unsafe impl VecZnxLshAddImpl<Self> for FFT64Ref
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshAddImpl<Self> for FFT64Ref
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxLshSubImpl<Self> for FFT64Ref
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshSubImpl<Self> for FFT64Ref
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
