//! Vector-of-ring-elements operations for [`NTTIfmaRef`](crate::NTTIfmaRef).
//!
//! Implements the `VecZnx*` OEP traits from `poulpy_hal::oep`. All implementations
//! delegate to the same backend-independent reference functions as `poulpy-cpu-ref`,
//! since the coefficient-domain operations work on plain `&[i64]` slices.
...
unsafe impl VecZnxZeroImpl<Self> for NTTIfmaRef {
    fn vec_znx_zero_impl<R>(_module: &Module<Self>, res: &mut R, res_col: usize)
    where
        R: VecZnxToMut,
    {
        vec_znx_zero::<_, NTTIfmaRef>(res, res_col);
    }
}

unsafe impl VecZnxNormalizeTmpBytesImpl<Self> for NTTIfmaRef {
    fn vec_znx_normalize_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_normalize_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxNormalizeImpl<Self> for NTTIfmaRef
where
...
unsafe impl VecZnxNormalizeInplaceImpl<Self> for NTTIfmaRef
where
    Self: TakeSliceImpl<Self> + VecZnxNormalizeTmpBytesImpl<Self>,
{
...
unsafe impl VecZnxAddImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxAddInplaceImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxAddScalarInplaceImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxAddScalarImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxSubImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxSubInplaceImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxSubNegateInplaceImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxSubScalarImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxSubScalarInplaceImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxNegateImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxNegateInplaceImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxLshAddImpl<Self> for NTTIfmaRef
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxLshSubImpl<Self> for NTTIfmaRef
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxLshInplaceImpl<Self> for NTTIfmaRef
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshImpl<Self> for NTTIfmaRef
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshAddImpl<Self> for NTTIfmaRef
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshSubImpl<Self> for NTTIfmaRef
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshInplaceImpl<Self> for NTTIfmaRef
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRotateImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxRotateInplaceTmpBytesImpl<Self> for NTTIfmaRef
where
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRotateInplaceImpl<Self> for NTTIfmaRef
where
    Scratch<Self>: TakeSlice,
...
unsafe impl VecZnxAutomorphismImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxAutomorphismInplaceTmpBytesImpl<Self> for NTTIfmaRef {
    fn vec_znx_automorphism_inplace_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_automorphism_inplace_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxAutomorphismInplaceImpl<Self> for NTTIfmaRef
where
    Scratch<Self>: TakeSlice,
...
unsafe impl VecZnxMulXpMinusOneImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxMulXpMinusOneInplaceTmpBytesImpl<Self> for NTTIfmaRef
where
    Scratch<Self>: TakeSlice,
...
unsafe impl VecZnxMulXpMinusOneInplaceImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxSplitRingTmpBytesImpl<Self> for NTTIfmaRef {
    fn vec_znx_split_ring_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_split_ring_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxSplitRingImpl<Self> for NTTIfmaRef
where
...
unsafe impl VecZnxMergeRingsTmpBytesImpl<Self> for NTTIfmaRef {
    fn vec_znx_merge_rings_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_merge_rings_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxMergeRingsImpl<Self> for NTTIfmaRef
where
...
unsafe impl VecZnxSwitchRingImpl<Self> for NTTIfmaRef
where
...
unsafe impl VecZnxCopyImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxFillUniformImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxFillNormalImpl<Self> for NTTIfmaRef {
...
unsafe impl VecZnxAddNormalImpl<Self> for NTTIfmaRef {
