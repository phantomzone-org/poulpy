//! Scratch (temporary) memory management for [`NTTIfmaRef`](crate::NTTIfmaRef).
//!
...
//! available-space queries.  Identical to the `poulpy-cpu-ref` NTT120 implementation --
...
unsafe impl<B: Backend> ScratchOwnedAllocImpl<B> for NTTIfmaRef {
...
unsafe impl<B: Backend> ScratchOwnedBorrowImpl<B> for NTTIfmaRef
where
...
unsafe impl<B: Backend> ScratchFromBytesImpl<B> for NTTIfmaRef {
...
unsafe impl<B: Backend> ScratchAvailableImpl<B> for NTTIfmaRef {
...
unsafe impl<B: Backend> TakeSliceImpl<B> for NTTIfmaRef
where
    B: ScratchFromBytesImpl<B>,
{
