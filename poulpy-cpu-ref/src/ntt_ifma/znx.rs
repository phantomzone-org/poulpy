...
impl ZnxAddAssign for NTTIfmaRef {
    #[inline(always)]
...
impl ZnxSubAssign for NTTIfmaRef {
    #[inline(always)]
...
impl ZnxSubNegateAssign for NTTIfmaRef {
    #[inline(always)]
...
impl ZnxMulPowerOfTwoAssign for NTTIfmaRef {
    #[inline(always)]
...
impl ZnxNegateAssign for NTTIfmaRef {
    #[inline(always)]
...
impl ZnxNormalizeFinalStepAssign for NTTIfmaRef {
    #[inline(always)]
...
impl ZnxNormalizeFirstStepAssign for NTTIfmaRef {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStepAssign for NTTIfmaRef {
    #[inline(always)]
