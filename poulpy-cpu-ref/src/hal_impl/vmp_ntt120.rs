macro_rules! hal_impl_vmp_ntt120 {
    () => {
        ...
        fn vmp_apply_dft_to_dft_accumulate_tmp_bytes(
            ...
            <Self as NTT120VmpDefaults<Self>>::vmp_apply_dft_to_dft_accumulate_tmp_bytes_default(
                module, res_size, a_size, b_rows, b_cols_in, b_cols_out, b_size,
            )
        }
        ...
        fn vmp_apply_dft_to_dft_accumulate<R, A, C>(
            ...
            C: VmpPMatToRef<Self>,
        {
            <Self as NTT120VmpDefaults<Self>>::vmp_apply_dft_to_dft_accumulate_default(module, res, a, b, limb_offset, scratch)
        }
