macro_rules! hal_impl_convolution_ntt_ifma {
    () => {
        ...
        fn cnv_apply_dft_tmp_bytes(
            ...
            <Self as NTT120IfmaConvolutionDefaults<Self>>::cnv_apply_dft_tmp_bytes_default(
        ...
        {
            <Self as NTT120IfmaConvolutionDefaults<Self>>::cnv_apply_dft_default(
        ...
        fn cnv_pairwise_apply_dft_tmp_bytes(
            ...
            <Self as NTT120IfmaConvolutionDefaults<Self>>::cnv_pairwise_apply_dft_tmp_bytes_default(
                module, cnv_offset, res_size, a_size, b_size,
            )
        }
        ...
        fn cnv_pairwise_apply_dft<R, A, B>(
            ...
            B: CnvPVecRToRef<Self>,
        {
            <Self as NTT120IfmaConvolutionDefaults<Self>>::cnv_pairwise_apply_dft_default(
