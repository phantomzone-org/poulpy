macro_rules! hal_impl_vec_znx_dft_ntt_ifma {
    () => {
        ...
        where
            ...
            A: VecZnxDftToRef<Self>,
        {
            <Self as NTTIfmaVecZnxDftDefaults<Self>>::vec_znx_dft_sub_inplace_default(module, res, res_col, a, a_col)
        }
        ...
        where
            ...
            A: VecZnxDftToRef<Self>,
        {
            <Self as NTTIfmaVecZnxDftDefaults<Self>>::vec_znx_dft_sub_negate_inplace_default(module, res, res_col, a, a_col)
        }
        ...
        {
            crate::ntt_ifma::vec_znx_dft::ntt_ifma_ref_idft_apply_consume(module, a)
        }
    };
}
