...
use crate::reference::vec_znx::{
    ...
    vec_znx_fill_normal_ref, vec_znx_fill_uniform_ref, vec_znx_lsh, vec_znx_lsh_inplace, vec_znx_lsh_sub, vec_znx_lsh_tmp_bytes,
...
pub trait HalVecZnxDefaults<BE: Backend>: Backend {
    ...
    fn vec_znx_normalize_inplace_default<R>(
        module: &Module<BE>,
        base2k: usize,
        res: &mut R,
        res_col: usize,
    ...
    fn vec_znx_sub_inplace_default<R, A>(_module: &Module<BE>, res: &mut R, res_col: usize, a: &A, a_col: usize)
    where
        BE: ZnxSubInplace,
        R: VecZnxToMut,
        A: VecZnxToRef,
    {
        vec_znx_sub_inplace::<R, A, BE>(res, res_col, a, a_col);
    }

    fn vec_znx_sub_negate_inplace_default<R, A>(_module: &Module<BE>, res: &mut R, res_col: usize, a: &A, a_col: usize)
    where
        BE: ZnxSubNegateInplace + ZnxNegateInplace,
        R: VecZnxToMut,
        A: VecZnxToRef,
    {
        vec_znx_sub_negate_inplace::<R, A, BE>(res, res_col, a, a_col);
    }
    ...
    fn vec_znx_sub_scalar_inplace_default<R, A>(
        _module: &Module<BE>,
        res: &mut R,
        res_col: usize,
        res_limb: usize,
        ...
        A: ScalarZnxToRef,
    {
        vec_znx_sub_scalar_inplace::<R, A, BE>(res, res_col, res_limb, a, a_col);
    }
    ...
    fn vec_znx_negate_inplace_default<R>(_module: &Module<BE>, res: &mut R, res_col: usize)
    where
        BE: ZnxNegateInplace,
        R: VecZnxToMut,
    {
        vec_znx_negate_inplace::<R, BE>(res, res_col);
    }
    ...
    fn vec_znx_rsh_inplace_default<R>(
        module: &Module<BE>,
        base2k: usize,
        k: usize,
        res: &mut R,
    ...
    fn vec_znx_lsh_inplace_default<R>(
        module: &Module<BE>,
        base2k: usize,
        k: usize,
        res: &mut R,
    ...
    fn vec_znx_rotate_inplace_tmp_bytes_default(module: &Module<BE>) -> usize {
        vec_znx_rotate_inplace_tmp_bytes(module.n())
    }

    fn vec_znx_rotate_inplace_default<R>(module: &Module<BE>, p: i64, res: &mut R, res_col: usize, scratch: &mut Scratch<BE>)
    where
        ...
        R: VecZnxToMut,
    {
        ...
        vec_znx_rotate_inplace::<R, BE>(p, res, res_col, tmp);
    }
    ...
    fn vec_znx_automorphism_inplace_tmp_bytes_default(module: &Module<BE>) -> usize {
        vec_znx_automorphism_inplace_tmp_bytes(module.n())
    }

    fn vec_znx_automorphism_inplace_default<R>(
        module: &Module<BE>,
        p: i64,
        res: &mut R,
        res_col: usize,
        ...
        R: VecZnxToMut,
    {
        ...
        vec_znx_automorphism_inplace::<R, BE>(p, res, res_col, tmp);
    }
    ...
    fn vec_znx_mul_xp_minus_one_inplace_tmp_bytes_default(module: &Module<BE>) -> usize {
        vec_znx_mul_xp_minus_one_inplace_tmp_bytes(module.n())
    }

    fn vec_znx_mul_xp_minus_one_inplace_default<R>(
        module: &Module<BE>,
        p: i64,
        res: &mut R,
        res_col: usize,
