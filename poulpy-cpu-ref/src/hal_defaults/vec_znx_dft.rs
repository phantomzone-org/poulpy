...
use crate::reference::{
    ...
    ntt_ifma::{
        ...
        vec_znx_dft::{
            ...
            ntt_ifma_vec_znx_dft_sub_assign as ntt_ifma_default_vec_znx_dft_sub_assign,
            ntt_ifma_vec_znx_dft_sub_negate_assign as ntt_ifma_default_vec_znx_dft_sub_negate_assign,
...
pub trait NTTIfmaVecZnxDftDefaults<BE: Backend>: Backend {
    ...
    where
        ...
        A: VecZnxDftToRef<BE>,
    {
        ntt_ifma_default_vec_znx_dft_sub_assign(res, res_col, a, a_col);
    }
    ...
    where
        ...
        A: VecZnxDftToRef<BE>,
    {
        ntt_ifma_default_vec_znx_dft_sub_negate_assign(res, res_col, a, a_col);
    }
