...
pub fn bench_convolution(c: &mut Criterion) {
    let group_name: String = "convolution_ref".to_string();
    ...
    fn runner(n: usize) -> impl FnMut() {
        ...
        let mut a_prep: CnvPVecL<Vec<u8>, FFT64Ref> = module.cnv_pvec_left_alloc(1, a_size);
        let mut b_prep: CnvPVecR<Vec<u8>, FFT64Ref> = module.cnv_pvec_right_alloc(1, b_size);
