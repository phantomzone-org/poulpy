//! NTT-domain vector operations for [`NTTIfma`](crate::NTTIfma).
//!
//! `VecZnxDft` stores ring element vectors in the Q120 NTT domain. This module
//! wires the IFMA backend into the generic forward-NTT, inverse-NTT, and
//! transform-domain arithmetic OEP traits.
//!
//! The main responsibilities are:
//!
//! - forward NTT from coefficient-domain `VecZnx`
//! - inverse NTT into `VecZnxBig`
//! - transform-domain add/sub/negate/copy/zero helpers
...
unsafe impl VecZnxIdftApplyTmpAImpl<Self> for NTTIfma {
...
unsafe impl VecZnxIdftApplyConsumeImpl<Self> for NTTIfma {
    fn vec_znx_idft_apply_consume_impl<D: Data>(module: &Module<NTTIfma>, mut a: VecZnxDft<D, NTTIfma>) -> VecZnxBig<D, NTTIfma>
    where
        VecZnxDft<D, NTTIfma>: VecZnxDftToMut<NTTIfma>,
    {
        ...
        let (n, n_blocks, u64_ptr) = {
            let mut a_mut: VecZnxDft<&mut [u8], NTTIfma> = a.to_mut();
            let n = a_mut.n();
        ...
        // Reinterpret the (now compacted) buffer as VecZnxBig<D, NTTIfma>.
...
unsafe impl VecZnxDftApplyImpl<Self> for NTTIfma {
...
unsafe impl VecZnxDftAddImpl<Self> for NTTIfma {
...
unsafe impl VecZnxDftAddScaledInplaceImpl<Self> for NTTIfma {
...
unsafe impl VecZnxDftAddInplaceImpl<Self> for NTTIfma {
...
unsafe impl VecZnxDftSubImpl<Self> for NTTIfma {
...
unsafe impl VecZnxDftSubInplaceImpl<Self> for NTTIfma {
...
unsafe impl VecZnxDftSubNegateInplaceImpl<Self> for NTTIfma {
...
unsafe impl VecZnxDftCopyImpl<Self> for NTTIfma {
...
unsafe impl VecZnxDftZeroImpl<Self> for NTTIfma {
