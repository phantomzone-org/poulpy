//! Coefficient-domain vector operations for [`NTTIfma`](crate::NTTIfma).
//!
//! `VecZnx` operations manipulate vectors of ring elements in coefficient form.
//! For the IFMA backend these paths are mostly backend-independent, so the module
//! reuses the same generic reference helpers as the portable backend and focuses on
//! trait integration rather than custom SIMD kernels.
...
unsafe impl VecZnxZeroImpl<Self> for NTTIfma {
    fn vec_znx_zero_impl<R>(_module: &Module<Self>, res: &mut R, res_col: usize)
    where
        R: VecZnxToMut,
    {
        vec_znx_zero::<_, NTTIfma>(res, res_col);
    }
}

unsafe impl VecZnxNormalizeTmpBytesImpl<Self> for NTTIfma {
    fn vec_znx_normalize_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_normalize_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxNormalizeImpl<Self> for NTTIfma
where
...
unsafe impl VecZnxNormalizeInplaceImpl<Self> for NTTIfma
where
    Self: TakeSliceImpl<Self> + VecZnxNormalizeTmpBytesImpl<Self>,
{
...
unsafe impl VecZnxAddImpl<Self> for NTTIfma {
...
unsafe impl VecZnxAddInplaceImpl<Self> for NTTIfma {
...
unsafe impl VecZnxAddScalarInplaceImpl<Self> for NTTIfma {
...
unsafe impl VecZnxAddScalarImpl<Self> for NTTIfma {
...
unsafe impl VecZnxSubImpl<Self> for NTTIfma {
...
unsafe impl VecZnxSubInplaceImpl<Self> for NTTIfma {
...
unsafe impl VecZnxSubNegateInplaceImpl<Self> for NTTIfma {
...
unsafe impl VecZnxSubScalarImpl<Self> for NTTIfma {
...
unsafe impl VecZnxSubScalarInplaceImpl<Self> for NTTIfma {
...
unsafe impl VecZnxNegateImpl<Self> for NTTIfma {
...
unsafe impl VecZnxNegateInplaceImpl<Self> for NTTIfma {
...
unsafe impl VecZnxLshAddImpl<Self> for NTTIfma
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxLshSubImpl<Self> for NTTIfma
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxLshInplaceImpl<Self> for NTTIfma
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshImpl<Self> for NTTIfma
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshAddImpl<Self> for NTTIfma
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshSubImpl<Self> for NTTIfma
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshInplaceImpl<Self> for NTTIfma
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRotateImpl<Self> for NTTIfma {
...
unsafe impl VecZnxRotateInplaceTmpBytesImpl<Self> for NTTIfma
where
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRotateInplaceImpl<Self> for NTTIfma
where
    Scratch<Self>: TakeSlice,
...
unsafe impl VecZnxAutomorphismImpl<Self> for NTTIfma {
...
unsafe impl VecZnxAutomorphismInplaceTmpBytesImpl<Self> for NTTIfma {
    fn vec_znx_automorphism_inplace_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_automorphism_inplace_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxAutomorphismInplaceImpl<Self> for NTTIfma
where
    Scratch<Self>: TakeSlice,
...
unsafe impl VecZnxMulXpMinusOneImpl<Self> for NTTIfma {
...
unsafe impl VecZnxMulXpMinusOneInplaceTmpBytesImpl<Self> for NTTIfma
where
    Scratch<Self>: TakeSlice,
...
unsafe impl VecZnxMulXpMinusOneInplaceImpl<Self> for NTTIfma {
...
unsafe impl VecZnxSplitRingTmpBytesImpl<Self> for NTTIfma {
    fn vec_znx_split_ring_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_split_ring_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxSplitRingImpl<Self> for NTTIfma
where
...
unsafe impl VecZnxMergeRingsTmpBytesImpl<Self> for NTTIfma {
    fn vec_znx_merge_rings_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_merge_rings_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxMergeRingsImpl<Self> for NTTIfma
where
...
unsafe impl VecZnxSwitchRingImpl<Self> for NTTIfma
where
...
unsafe impl VecZnxCopyImpl<Self> for NTTIfma {
...
unsafe impl VecZnxFillUniformImpl<Self> for NTTIfma {
...
unsafe impl VecZnxFillNormalImpl<Self> for NTTIfma {
...
unsafe impl VecZnxAddNormalImpl<Self> for NTTIfma {
