...
impl ZnxSubNegateAssign for NTTIfma {
    #[inline(always)]
...
impl ZnxMulPowerOfTwoAssign for NTTIfma {
    #[inline(always)]
...
impl ZnxNegateAssign for NTTIfma {
    #[inline(always)]
...
impl ZnxNormalizeFinalStepAssign for NTTIfma {
    #[inline(always)]
...
impl ZnxNormalizeFirstStepAssign for NTTIfma {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStepAssign for NTTIfma {
    #[inline(always)]
