...
unsafe impl VecZnxZeroImpl<Self> for FFT64Ifma {
    fn vec_znx_zero_impl<R>(_module: &Module<Self>, res: &mut R, res_col: usize)
    where
        R: VecZnxToMut,
    {
        vec_znx_zero::<_, FFT64Ifma>(res, res_col);
    }
}

unsafe impl VecZnxNormalizeTmpBytesImpl<Self> for FFT64Ifma {
    fn vec_znx_normalize_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_normalize_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxNormalizeImpl<Self> for FFT64Ifma
where
...
unsafe impl VecZnxNormalizeInplaceImpl<Self> for FFT64Ifma
where
    Self: TakeSliceImpl<Self> + VecZnxNormalizeTmpBytesImpl<Self>,
{
...
unsafe impl VecZnxAddImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxAddInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxAddScalarInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxAddScalarImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxSubImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxSubInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxSubNegateInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxSubScalarImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxSubScalarInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxNegateImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxNegateInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxLshAddImpl<Self> for FFT64Ifma
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxLshSubImpl<Self> for FFT64Ifma
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxLshInplaceImpl<Self> for FFT64Ifma
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshImpl<Self> for FFT64Ifma
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshAddImpl<Self> for FFT64Ifma
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshSubImpl<Self> for FFT64Ifma
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRshInplaceImpl<Self> for FFT64Ifma
where
    Module<Self>: VecZnxNormalizeTmpBytes,
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRotateImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxRotateInplaceTmpBytesImpl<Self> for FFT64Ifma
where
    Scratch<Self>: TakeSlice,
{
...
unsafe impl VecZnxRotateInplaceImpl<Self> for FFT64Ifma
where
    Scratch<Self>: TakeSlice,
...
unsafe impl VecZnxAutomorphismImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxAutomorphismInplaceTmpBytesImpl<Self> for FFT64Ifma {
    fn vec_znx_automorphism_inplace_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_automorphism_inplace_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxAutomorphismInplaceImpl<Self> for FFT64Ifma
where
    Scratch<Self>: TakeSlice,
...
unsafe impl VecZnxMulXpMinusOneImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxMulXpMinusOneInplaceTmpBytesImpl<Self> for FFT64Ifma
where
    Scratch<Self>: TakeSlice,
...
unsafe impl VecZnxMulXpMinusOneInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxSplitRingTmpBytesImpl<Self> for FFT64Ifma {
    fn vec_znx_split_ring_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_split_ring_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxSplitRingImpl<Self> for FFT64Ifma
where
...
unsafe impl VecZnxMergeRingsTmpBytesImpl<Self> for FFT64Ifma {
    fn vec_znx_merge_rings_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_merge_rings_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxMergeRingsImpl<Self> for FFT64Ifma
where
...
unsafe impl VecZnxSwitchRingImpl<Self> for FFT64Ifma
where
...
unsafe impl VecZnxCopyImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxFillUniformImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxFillNormalImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxAddNormalImpl<Self> for FFT64Ifma {
