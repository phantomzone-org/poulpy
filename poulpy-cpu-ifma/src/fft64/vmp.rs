...
unsafe impl VmpApplyDftToDftImpl<Self> for FFT64Ifma
where
    Scratch<Self>: TakeSlice,
    FFT64Ifma: VmpApplyDftToDftTmpBytesImpl<Self>,
{
        ...
        C: VmpPMatToRef<Self>,
    {
        ...
        vmp_apply_dft_to_dft(&mut res, &a, &pmat, limb_offset, tmp);
    }
}

unsafe impl VmpPrepareTmpBytesImpl<Self> for FFT64Ifma {
...
unsafe impl VmpPrepareImpl<Self> for FFT64Ifma {
...
unsafe impl VmpApplyDftToDftTmpBytesImpl<Self> for FFT64Ifma {
...
unsafe impl VmpZeroImpl<Self> for FFT64Ifma {
