...
unsafe impl VecZnxIdftApplyTmpBytesImpl<Self> for FFT64Ifma {
    fn vec_znx_idft_apply_tmp_bytes_impl(_module: &Module<Self>) -> usize {
        0
    }
}

unsafe impl VecZnxIdftApplyImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxIdftApplyTmpAImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxIdftApplyConsumeImpl<Self> for FFT64Ifma {
    fn vec_znx_idft_apply_consume_impl<D: Data>(module: &Module<Self>, res: VecZnxDft<D, FFT64Ifma>) -> VecZnxBig<D, FFT64Ifma>
    where
        VecZnxDft<D, FFT64Ifma>: VecZnxDftToMut<Self>,
    {
        vec_znx_idft_apply_consume(module.get_ifft_table(), res)
    }
}

unsafe impl VecZnxDftApplyImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxDftAddImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxDftAddInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxDftAddScaledInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxDftSubImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxDftSubInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxDftSubNegateInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxDftCopyImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxDftZeroImpl<Self> for FFT64Ifma {
