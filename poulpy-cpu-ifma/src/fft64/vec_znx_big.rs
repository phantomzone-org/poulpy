...
unsafe impl VecZnxBigFromSmallImpl<Self> for FFT64Ifma {
    fn vec_znx_big_from_small_impl<R, A>(res: &mut R, res_col: usize, a: &A, a_col: usize)
    where
        R: VecZnxBigToMut<Self>,
        A: VecZnxToRef,
    {
        let mut res: VecZnxBig<&mut [u8], FFT64Ifma> = res.to_mut();
...
unsafe impl VecZnxBigAddNormalImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxBigAddImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxBigAddInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxBigAddSmallImpl<Self> for FFT64Ifma {
    /// Adds `a` to `b` and stores the result on `c`.
...
unsafe impl VecZnxBigAddSmallInplaceImpl<Self> for FFT64Ifma {
    /// Adds `a` to `b` and stores the result on `b`.
...
unsafe impl VecZnxBigSubImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxBigSubInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxBigSubNegateInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxBigSubSmallAImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxBigSubSmallInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxBigSubSmallBImpl<Self> for FFT64Ifma {
    /// Subtracts `b` from `a` and stores the result on `c`.
...
unsafe impl VecZnxBigSubSmallNegateInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxBigNegateImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxBigNegateInplaceImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxBigNormalizeTmpBytesImpl<Self> for FFT64Ifma {
    fn vec_znx_big_normalize_tmp_bytes_impl(module: &Module<Self>) -> usize {
        vec_znx_big_normalize_tmp_bytes(module.n())
    }
}

unsafe impl VecZnxBigNormalizeImpl<Self> for FFT64Ifma
where
...
unsafe impl VecZnxBigAutomorphismImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxBigAutomorphismInplaceTmpBytesImpl<Self> for FFT64Ifma {
...
unsafe impl VecZnxBigAutomorphismInplaceImpl<Self> for FFT64Ifma
where
