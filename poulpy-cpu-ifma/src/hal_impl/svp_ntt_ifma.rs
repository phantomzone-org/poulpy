macro_rules! hal_impl_svp_ntt_ifma {
    () => {
        ...
        where
            ...
            A: ScalarZnxToRef,
        {
            <Self as NTTIfmaSvpDefaults<Self>>::svp_prepare_default(module, res, res_col, a, a_col)
        }
        ...
        where
            ...
            C: VecZnxToRef,
        {
            <Self as NTTIfmaSvpDefaults<Self>>::svp_apply_dft_default(module, res, res_col, a, a_col, b, b_col)
        }
