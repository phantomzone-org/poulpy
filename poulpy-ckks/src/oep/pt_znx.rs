...
macro_rules! impl_ckks_pt_znx_default_methods {
    ($backend:ty) => {
        ...
        {
            <poulpy_hal::layouts::Module<$backend> as $crate::leveled::default::pt_znx::CKKSPlaintextZnxDefault<$backend>>::ckks_add_pt_znx_tmp_bytes_default(module)
        }
        ...
        {
            <poulpy_hal::layouts::Module<$backend> as $crate::leveled::default::pt_znx::CKKSPlaintextZnxDefault<$backend>>::ckks_add_pt_vec_znx_default(module, dst, src, scratch)
        }
        ...
        where
            poulpy_hal::layouts::Module<$backend>: poulpy_hal::api::VecZnxRshTmpBytes,
        {
            <poulpy_hal::layouts::Module<$backend> as $crate::leveled::default::pt_znx::CKKSPlaintextZnxDefault<$backend>>::ckks_sub_pt_znx_tmp_bytes_default(module)
        }
        ...
        {
            <poulpy_hal::layouts::Module<$backend> as $crate::leveled::default::pt_znx::CKKSPlaintextZnxDefault<$backend>>::ckks_sub_pt_vec_znx_default(module, dst, src, scratch)
        }
