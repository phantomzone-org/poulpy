...
macro_rules! impl_ckks_sub_default_methods {
    ($backend:ty) => {
        ...
        where
            ...
            poulpy_hal::layouts::Scratch<$backend>: poulpy_hal::api::ScratchAvailable + poulpy_core::ScratchTakeCore<$backend>,
        {
            <poulpy_hal::layouts::Module<$backend> as $crate::leveled::default::sub::CKKSSubDefault<$backend>>::ckks_sub_pt_const_znx_default(module, dst, a, cst_znx, scratch)
        }
        ...
        where
            poulpy_hal::layouts::Scratch<$backend>: poulpy_hal::api::ScratchAvailable + poulpy_core::ScratchTakeCore<$backend>,
        {
            <poulpy_hal::layouts::Module<$backend> as $crate::leveled::default::sub::CKKSSubDefault<$backend>>::ckks_sub_pt_const_znx_inplace_default(module, dst, cst_znx, scratch)
        }
        ...
        {
            <poulpy_hal::layouts::Module<$backend> as $crate::leveled::default::sub::CKKSSubDefault<$backend>>::ckks_sub_pt_const_rnx_default(module, dst, a, cst_rnx, prec, scratch)
        }
        ...
        where
            ...
            $crate::layouts::plaintext::CKKSPlaintextCstRnx<F>: $crate::layouts::plaintext::CKKSConstPlaintextConversion,
        {
            <poulpy_hal::layouts::Module<$backend> as $crate::leveled::default::sub::CKKSSubDefault<$backend>>::ckks_sub_pt_const_rnx_inplace_default(module, dst, cst_rnx, prec, scratch)
        }
    };
}
