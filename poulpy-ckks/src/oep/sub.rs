...
macro_rules! impl_ckks_sub_default_methods {
    ($backend:ty) => {
        ...
        fn ckks_sub_into<Dst: poulpy_hal::layouts::Data, A: poulpy_hal::layouts::Data, B: poulpy_hal::layouts::Data>(
        ...
        fn ckks_sub_assign<Dst: poulpy_hal::layouts::Data, A: poulpy_hal::layouts::Data>(
            module: &poulpy_hal::layouts::Module<$backend>,
            dst: &mut $crate::layouts::CKKSCiphertext<Dst>,
            a: &$crate::layouts::CKKSCiphertext<A>,
            scratch: &mut poulpy_hal::layouts::ScratchArena<'_, $backend>,
        ...
        fn ckks_sub_pt_vec_znx_into<Dst: poulpy_hal::layouts::Data, A: poulpy_hal::layouts::Data, P: poulpy_hal::layouts::Data>(
            module: &poulpy_hal::layouts::Module<$backend>,
            dst: &mut $crate::layouts::CKKSCiphertext<Dst>,
            a: &$crate::layouts::CKKSCiphertext<A>,
        ...
        fn ckks_sub_pt_vec_znx_assign<Dst: poulpy_hal::layouts::Data, P: poulpy_hal::layouts::Data>(
            module: &poulpy_hal::layouts::Module<$backend>,
            dst: &mut $crate::layouts::CKKSCiphertext<Dst>,
            pt_znx: &$crate::layouts::plaintext::CKKSPlaintextVecZnx<P>,
            scratch: &mut poulpy_hal::layouts::ScratchArena<'_, $backend>,
        ...
        fn ckks_sub_pt_vec_rnx_into<Dst: poulpy_hal::layouts::Data, A: poulpy_hal::layouts::Data, F>(
            module: &poulpy_hal::layouts::Module<$backend>,
            dst: &mut $crate::layouts::CKKSCiphertext<Dst>,
            a: &$crate::layouts::CKKSCiphertext<A>,
        ...
        where
            poulpy_hal::layouts::Module<$backend>: poulpy_hal::api::ModuleN + poulpy_hal::api::VecZnxRshSubBackend<$backend> + poulpy_core::GLWEShift<$backend>,
            $crate::layouts::CKKSCiphertext<Dst>: poulpy_core::layouts::GLWEToBackendMut<$backend>,
            $crate::layouts::CKKSCiphertext<A>: poulpy_core::layouts::GLWEToBackendRef<$backend>,
            for<'a> poulpy_hal::layouts::ScratchArena<'a, $backend>: poulpy_hal::api::ScratchAvailable + poulpy_core::ScratchArenaTakeCore<'a, $backend>,
        ...
        fn ckks_sub_pt_vec_rnx_assign<Dst: poulpy_hal::layouts::Data, F>(
            module: &poulpy_hal::layouts::Module<$backend>,
            dst: &mut $crate::layouts::CKKSCiphertext<Dst>,
            pt_rnx: &$crate::layouts::plaintext::CKKSPlaintextVecRnx<F>,
            prec: $crate::CKKSMeta,
        ...
        where
            poulpy_hal::layouts::Module<$backend>: poulpy_hal::api::ModuleN + poulpy_hal::api::VecZnxRshSubBackend<$backend>,
            $crate::layouts::CKKSCiphertext<Dst>: poulpy_core::layouts::GLWEToBackendMut<$backend>,
            for<'a> poulpy_hal::layouts::ScratchArena<'a, $backend>: poulpy_hal::api::ScratchAvailable + poulpy_core::ScratchArenaTakeCore<'a, $backend>,
            $crate::layouts::plaintext::CKKSPlaintextVecRnx<F>: $crate::layouts::plaintext::CKKSPlaintextConversion,
        {
        ...
        fn ckks_sub_pt_const_znx_into<Dst: poulpy_hal::layouts::Data, A: poulpy_hal::layouts::Data>(
            module: &poulpy_hal::layouts::Module<$backend>,
            dst: &mut $crate::layouts::CKKSCiphertext<Dst>,
            a: &$crate::layouts::CKKSCiphertext<A>,
        ...
        fn ckks_sub_pt_const_znx_assign<Dst: poulpy_hal::layouts::Data>(
            module: &poulpy_hal::layouts::Module<$backend>,
            dst: &mut $crate::layouts::CKKSCiphertext<Dst>,
            cst_znx: &$crate::layouts::plaintext::CKKSPlaintextCstZnx,
            scratch: &mut poulpy_hal::layouts::ScratchArena<'_, $backend>,
        ...
        fn ckks_sub_pt_const_rnx_into<Dst: poulpy_hal::layouts::Data, A: poulpy_hal::layouts::Data, F>(
            module: &poulpy_hal::layouts::Module<$backend>,
            dst: &mut $crate::layouts::CKKSCiphertext<Dst>,
            a: &$crate::layouts::CKKSCiphertext<A>,
        ...
        fn ckks_sub_pt_const_rnx_assign<Dst: poulpy_hal::layouts::Data, F>(
            module: &poulpy_hal::layouts::Module<$backend>,
            dst: &mut $crate::layouts::CKKSCiphertext<Dst>,
            cst_rnx: &$crate::layouts::plaintext::CKKSPlaintextCstRnx<F>,
            prec: $crate::CKKSMeta,
