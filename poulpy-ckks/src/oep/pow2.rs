...
macro_rules! impl_ckks_pow2_default_methods {
    ($backend:ty) => {
        ...
        {
            <poulpy_hal::layouts::Module<$backend> as $crate::leveled::default::pow2::CKKSPow2Default<$backend>>::ckks_mul_pow2_default(module, dst, src, bits, scratch)
        }
        ...
        where
            ...
            poulpy_hal::layouts::Scratch<$backend>: poulpy_core::ScratchTakeCore<$backend>,
        {
            <poulpy_hal::layouts::Module<$backend> as $crate::leveled::default::pow2::CKKSPow2Default<$backend>>::ckks_mul_pow2_inplace_default(module, dst, bits, scratch)
        }
        ...
        where
            ...
            poulpy_hal::layouts::Scratch<$backend>: poulpy_core::ScratchTakeCore<$backend>,
        {
            <poulpy_hal::layouts::Module<$backend> as $crate::leveled::default::pow2::CKKSPow2Default<$backend>>::ckks_div_pow2_default(module, dst, src, bits, scratch)
        }
        ...
        fn ckks_div_pow2_inplace(
            ...
            <poulpy_hal::layouts::Module<$backend> as $crate::leveled::default::pow2::CKKSPow2Default<$backend>>::ckks_div_pow2_inplace_default(module, dst, bits)
        }
    };
}
