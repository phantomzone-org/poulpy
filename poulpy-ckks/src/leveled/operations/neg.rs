...
impl<BE: Backend> CKKSNegOpsDefault<BE> for Module<BE> {}

impl<BE: Backend> CKKSNegOps<BE> for Module<BE>
where
    Module<BE>: CKKSNegOpsDefault<BE>,
{
    ...
    where
        ...
        Scratch<BE>: ScratchAvailable + ScratchTakeCore<BE>,
    {
        self.ckks_neg_default(dst, src, scratch)
    }
    ...
    where
        Self: GLWENegate,
    {
        self.ckks_neg_inplace_default(dst)
    }
}
