//! Unnormalized variants of CKKS subtraction.
//!
//! These methods skip the trailing `glwe_normalize_inplace` that the safe
//! [`CKKSSubOps`] variants perform after each operation. They exist because
...
use anyhow::Result;
use poulpy_core::{GLWEShift, GLWESub, ScratchTakeCore};
use poulpy_hal::{
    api::{ModuleN, ScratchAvailable, VecZnxRshSub},
...
use super::default_impl::CKKSSubDefault;

/// Opt-in API exposing unnormalized CKKS subtraction variants.
///
/// # Safety
