...
pub fn test_sub_pt_znx_inplace<BE: Backend>(ctx: &TestContext<BE>) {
    ...
    ctx.module
        .ckks_sub_pt_znx_inplace(&mut ct, &pt_znx, scratch.borrow())
        .unwrap();
...
pub fn test_sub_pt_znx<BE: Backend>(ctx: &TestContext<BE>) {
    ...
    let mut ct_res = ctx.alloc_ct(ctx.max_k());
    ctx.module
        .ckks_sub_pt_znx(&mut ct_res, &ct1, &pt_znx, scratch.borrow())
        .unwrap();
...
pub fn test_sub_pt_rnx_inplace<BE: Backend>(ctx: &TestContext<BE>) {
    ...
    let expected_log_hom_rem = ct.log_hom_rem();
    ctx.module
        .ckks_sub_pt_rnx_inplace(&mut ct, &pt_rnx, ctx.meta(), scratch.borrow())
        .unwrap();
...
pub fn test_sub_pt_rnx<BE: Backend>(ctx: &TestContext<BE>) {
    ...
    let mut ct_res = ctx.alloc_ct(ctx.max_k());
    ctx.module
        .ckks_sub_pt_rnx(&mut ct_res, &ct1, &pt_rnx, ctx.meta(), scratch.borrow())
        .unwrap();
...
pub fn test_sub_pt_rnx_delta_log_decimal<BE: Backend>(ctx: &TestContext<BE>) {
    ...
    let mut ct_res = ctx.alloc_ct(ctx.max_k());
    ctx.module
        .ckks_sub_pt_rnx(&mut ct_res, &ct1, &pt_rnx, low_prec, scratch.borrow())
        .unwrap();
