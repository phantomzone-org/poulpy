...
use crate::{
    ...
    leveled::{
        ...
        operations::add::{
            add, add_const, add_const_inplace, add_const_tmp_bytes, add_inplace, add_pt, add_pt_inplace, add_pt_tmp_bytes,
        },
    },
};
use poulpy_core::{
    ...
    Scratch<BE>: ScratchTakeCore<BE>,
{
    ...
    add(&ctx.module, &mut ct_res, &ct1, &ct2);
    ...
    add_inplace(&ctx.module, &mut ct_ip, &ct2);
