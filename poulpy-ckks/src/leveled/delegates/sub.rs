...
impl<BE: Backend + CKKSImpl<BE>> CKKSSubOps<BE> for Module<BE> {
    ...
    where
        Self: GLWEShift<BE>,
    {
        CKKSSubOep::ckks_sub_const_tmp_bytes(self)
    }
...
use crate::leveled::api::CKKSSubOpsWithoutNormalization;
use crate::leveled::default::CKKSSubDefault;

unsafe impl<BE: Backend> CKKSSubOpsWithoutNormalization<BE> for Module<BE>
where
