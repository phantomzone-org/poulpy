...
use poulpy_hal::{
    api::{
        ModuleN, ScratchAvailable, VecZnxAddConstAssignBackend, VecZnxRshCoeffBackend, VecZnxRshSubBackend, VecZnxRshTmpBytes,
...
where
    Module<BE>: GLWEShift<BE>
        + GLWESub<BE>
        + ModuleN
        + VecZnxAddConstAssignBackend<BE>
    ...
    for<'a> ScratchArena<'a, BE>: ScratchAvailable + ScratchArenaTakeCore<'a, BE>,
{
        ...
        B: CKKSCiphertextToBackendRef<BE> + CKKSInfos,
    {
        ...
        let res = CKKSSubOep::ckks_sub_into(self, &mut dst_ct, &a_ct, &b_ct, scratch);
        ...
        A: CKKSCiphertextToBackendRef<BE> + CKKSInfos,
    {
        ...
        let mut dst_ct = CKKSCiphertext::from_inner(GLWEToBackendMut::to_backend_mut(dst), dst_meta);
        let a_ct = CKKSCiphertext::from_inner(GLWEToBackendRef::to_backend_ref(a), a.meta());
        let res = CKKSSubOep::ckks_sub_assign(self, &mut dst_ct, &a_ct, scratch);
        let new_meta = dst_ct.meta();
        drop(dst_ct);
        dst.set_meta(new_meta);
        res
        ...
        P: CKKSPlaintexToBackendRef<BE> + CKKSInfos,
    {
        ...
        let mut dst_ct = CKKSCiphertext::from_inner(GLWEToBackendMut::to_backend_mut(dst), dst_meta);
        let a_ct = CKKSCiphertext::from_inner(GLWEToBackendRef::to_backend_ref(a), a.meta());
        let res = CKKSSubOep::ckks_sub_pt_vec_znx_into(self, &mut dst_ct, &a_ct, pt_znx, scratch);
        let new_meta = dst_ct.meta();
        drop(dst_ct);
        dst.set_meta(new_meta);
        res
        ...
        P: CKKSPlaintexToBackendRef<BE> + CKKSInfos,
    {
        let dst_meta = dst.meta();
        let mut dst_ct = CKKSCiphertext::from_inner(GLWEToBackendMut::to_backend_mut(dst), dst_meta);
        let res = CKKSSubOep::ckks_sub_pt_vec_znx_assign(self, &mut dst_ct, pt_znx, scratch);
        let new_meta = dst_ct.meta();
        drop(dst_ct);
        dst.set_meta(new_meta);
        res
        ...
        P: CKKSPlaintexToBackendRef<BE> + CKKSInfos,
    {
        ...
        let mut dst_ct = CKKSCiphertext::from_inner(GLWEToBackendMut::to_backend_mut(dst), dst_meta);
        let a_ct = CKKSCiphertext::from_inner(GLWEToBackendRef::to_backend_ref(a), a.meta());
        let res = CKKSSubOep::ckks_sub_pt_const_znx_into(self, &mut dst_ct, &a_ct, dst_coeff, pt_znx, pt_coeff, scratch);
        let new_meta = dst_ct.meta();
        drop(dst_ct);
        dst.set_meta(new_meta);
        res
        ...
        P: CKKSPlaintexToBackendRef<BE> + CKKSInfos,
    {
        let dst_meta = dst.meta();
        let mut dst_ct = CKKSCiphertext::from_inner(GLWEToBackendMut::to_backend_mut(dst), dst_meta);
        let res = CKKSSubOep::ckks_sub_pt_const_znx_assign(self, &mut dst_ct, dst_coeff, pt_znx, pt_coeff, scratch);
        let new_meta = dst_ct.meta();
        drop(dst_ct);
        dst.set_meta(new_meta);
        res
    ...
    for<'a> ScratchArena<'a, BE>: ScratchAvailable + ScratchArenaTakeCore<'a, BE>,
{
        ...
        B: CKKSCiphertextToBackendRef<BE> + CKKSInfos,
    {
        ...
        let a_ct_ref = &a_ct;
        let b_ct_ref = &b_ct;
        let res = self.ckks_sub_into_unsafe_default(&mut dst_ct_ref, &a_ct_ref, &b_ct_ref, scratch);
        let new_meta = dst_ct.meta();
        drop(dst_ct);
        dst.set_meta(new_meta);
        res
        ...
        A: CKKSCiphertextToBackendRef<BE> + CKKSInfos,
    {
        ...
        let mut dst_ct_ref = &mut dst_ct;
        let a_ct_ref = &a_ct;
        let res = self.ckks_sub_assign_unsafe_default(&mut dst_ct_ref, &a_ct_ref, scratch);
        let new_meta = dst_ct.meta();
        drop(dst_ct);
        dst.set_meta(new_meta);
        res
        ...
        P: CKKSPlaintexToBackendRef<BE> + CKKSInfos,
    {
        ...
        let mut dst_ct_ref = &mut dst_ct;
        let a_ct_ref = &a_ct;
        let res = self.ckks_sub_pt_vec_znx_into_unsafe_default(&mut dst_ct_ref, &a_ct_ref, pt_znx, scratch);
        let new_meta = dst_ct.meta();
        drop(dst_ct);
        dst.set_meta(new_meta);
        res
        ...
        P: CKKSPlaintexToBackendRef<BE> + CKKSInfos,
    {
        ...
        let mut dst_ct = CKKSCiphertext::from_inner(GLWEToBackendMut::to_backend_mut(dst), dst_meta);
        let mut dst_ct_ref = &mut dst_ct;
        let res = self.ckks_sub_pt_vec_znx_assign_unsafe_default(&mut dst_ct_ref, pt_znx, scratch);
        let new_meta = dst_ct.meta();
        drop(dst_ct);
        dst.set_meta(new_meta);
        res
        ...
        P: CKKSPlaintexToBackendRef<BE> + CKKSInfos,
    {
        ...
        let mut dst_ct_ref = &mut dst_ct;
        let a_ct_ref = &a_ct;
        let res = self.ckks_sub_pt_const_znx_into_unsafe_default(&mut dst_ct_ref, &a_ct_ref, dst_coeff, pt_znx, pt_coeff, scratch);
        let new_meta = dst_ct.meta();
        drop(dst_ct);
        dst.set_meta(new_meta);
        res
        ...
        P: CKKSPlaintexToBackendRef<BE> + CKKSInfos,
    {
        ...
        let mut dst_ct = CKKSCiphertext::from_inner(GLWEToBackendMut::to_backend_mut(dst), dst_meta);
        let mut dst_ct_ref = &mut dst_ct;
        let res = self.ckks_sub_pt_const_znx_assign_unsafe_default(&mut dst_ct_ref, dst_coeff, pt_znx, pt_coeff, scratch);
        let new_meta = dst_ct.meta();
        drop(dst_ct);
        dst.set_meta(new_meta);
        res
